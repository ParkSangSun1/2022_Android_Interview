# 시작하기 전에
### 아래 링크로 대체되었습니다
### https://asuhdevstory.tistory.com/entry/%EC%95%88%EB%93%9C%EB%A1%9C%EC%9D%B4%EB%93%9C-%EB%A9%B4%EC%A0%91-%EC%A7%88%EB%AC%B8-%EB%8C%80%EB%B9%84
### <br>
# 안드로이드 개념적인 부분
## 안드로이드 4대 컴포넌트
...
## Context란?
#### 애플리케이션의 현재 상태를 나타내고 액티비티와 어플리케이션의 정보를 얻기 위해 사용할 수 있음
...
## 컴파일 타임, 런 타임 이란?
#### 컴파일 타임은 작성된 소스코드를 기계어코드로 변환 되어 실행가능한 프로그램으로 만드는 과정
#### 런 타임은 컴파일된 프로그램이 사용자에 의해 실행되어 동작할 때
#### <br>
...
## 람다식이란?
#### 함수에 대한 이론적 기반을 세우는 수학적 추상화를 뜻함, 이것을 표현하면 람다표현식
#### <br>
